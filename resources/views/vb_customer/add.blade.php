                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" name="alamat_customer" id="alamat_customer" rows="4" autocomplete="off"></textarea>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" name="keterangan_cus" id="keterangan_cus" rows="4" autocomplete="off"></textarea>
                                    </div>
                                </div>
                            </div>                      
